...
### [1.557.1-prerelease.1738058892665](https://github.com/bigcommerce/checkout-js/compare/v1.509.1...v1.557.1-prerelease.1738058892665) (2025-01-28)


### Features

* **checkout:** CHECKOUT-8519 Load scripts with integrity hashes to meet PCI4 requirements ([5b2ee50](https://github.com/bigcommerce/checkout-js/commit/5b2ee50bc3d567a9a25b7ed2a9d41d92076c11e3))
* **checkout:** CHECKOUT-8519 Switch messageformat library when experiment is enabled ([8ba4e06](https://github.com/bigcommerce/checkout-js/commit/8ba4e06f060296e992c19a5abb4a93d8af98a6aa))
* **checkout:** CHECKOUT-8597 Choose Multi-shipping Shipping Method ([#2080](https://github.com/bigcommerce/checkout-js/issues/2080)) ([6fa67f3](https://github.com/bigcommerce/checkout-js/commit/6fa67f3b74e5579aaa21c072f46ce964b3e6b36f))
* **checkout:** CHECKOUT-8597 Fix CI ([#2085](https://github.com/bigcommerce/checkout-js/issues/2085)) ([b302ca1](https://github.com/bigcommerce/checkout-js/commit/b302ca1fb38367dbf9281e57e663d4412e622d72))
* **checkout:** CHECKOUT-8597 Improve tests ([#2092](https://github.com/bigcommerce/checkout-js/issues/2092)) ([1221c23](https://github.com/bigcommerce/checkout-js/commit/1221c2340ea08525ef2c026d76e4a8a506567cac))
* **checkout:** CHECKOUT-8598 Display Items Allocated Banner ([a5e308f](https://github.com/bigcommerce/checkout-js/commit/a5e308f90a6623ff94d5c31070a7b06b0fb00ca6))
* **checkout:** CHECKOUT-8599 Add Confirmation Modal for Multi-shipping ([#2055](https://github.com/bigcommerce/checkout-js/issues/2055)) ([01426a0](https://github.com/bigcommerce/checkout-js/commit/01426a05fa55aaa96d15f9883b898caaa85074b4))
* **checkout:** CHECKOUT-8600 Add digital item no shipping banner ([305d7aa](https://github.com/bigcommerce/checkout-js/commit/305d7aaa4521a8ed7e782dd39bfa9aa03cba54e7))
* **checkout:** CHECKOUT-8601 Enhanced Multi-Address Shipping Summary View ([018265d](https://github.com/bigcommerce/checkout-js/commit/018265d28bda9d08c9fcf31e8e46499043c290ce))
* **checkout:** CHECKOUT-8774 Display item split tooltip ([96cfcf4](https://github.com/bigcommerce/checkout-js/commit/96cfcf408fd9fbd819935139c9d722af2c7b4bd3))
* **checkout:** CHECKOUT-8774 improve coding ([976af4a](https://github.com/bigcommerce/checkout-js/commit/976af4a6b0c1c766de7ea5beb6a5912716a04c18))
* **checkout:** CHECKOUT-8777 Delete a consignment ([beb3fb0](https://github.com/bigcommerce/checkout-js/commit/beb3fb0d25b3ea2c2a9fe3dd670e863828a661b0))
* **checkout:** CHECKOUT-8780 Add translated strings for all the text used in new multi shipping UI ([#2102](https://github.com/bigcommerce/checkout-js/issues/2102)) ([c555101](https://github.com/bigcommerce/checkout-js/commit/c55510150e4512757e0db095c1978b5c0200181f))
* **checkout:** CHECKOUT-8786 Disable Integrity for Local Dev ([#2068](https://github.com/bigcommerce/checkout-js/issues/2068)) ([ad9f6cf](https://github.com/bigcommerce/checkout-js/commit/ad9f6cfd9dc263cf39b04114227ab06beba943ab))
* **checkout:** CHECKOUT-8786 Remove Integrity Attribute in Dev ([#2076](https://github.com/bigcommerce/checkout-js/issues/2076)) ([fea71bd](https://github.com/bigcommerce/checkout-js/commit/fea71bd03274ac30afe5ae0f004a6ab9c6222b7a))
* **checkout:** CHECKOUT-8790 Display detailed error when applying coupon fails on checkout ([#2075](https://github.com/bigcommerce/checkout-js/issues/2075)) ([552b533](https://github.com/bigcommerce/checkout-js/commit/552b533b75a0292190242a912d41f6cac49e9eba))
* **checkout:** CHECKOUT-8824 Add Consignment Not Completed Message ([#2099](https://github.com/bigcommerce/checkout-js/issues/2099)) ([c25c057](https://github.com/bigcommerce/checkout-js/commit/c25c05773b41684f919d2d131e42976b638b7476))
* **checkout:** CHECKOUT-8869 Remove Available Shipping Option Check ([#2111](https://github.com/bigcommerce/checkout-js/issues/2111)) ([5efd8cd](https://github.com/bigcommerce/checkout-js/commit/5efd8cdd68ba1a80964186eaa8ae75fe6f8443ec))
* **checkout:** CHECKOUT-8959 Update Reload Checkout Handler ([#2146](https://github.com/bigcommerce/checkout-js/issues/2146)) ([b969a42](https://github.com/bigcommerce/checkout-js/commit/b969a4251b340993e7e81fc39d9165c404bb3839))
* **checkout:** DATA-11983 Bump checkout-sdk version ([c0e69cb](https://github.com/bigcommerce/checkout-js/commit/c0e69cb3265e18456e7d157d93e3aa20a48bb88a))
...
* **checkout:** PI-2944 Update HostedFormOptions usage in checkout-js after renaming ([#2110](https://github.com/bigcommerce/checkout-js/issues/2110)) ([87c16d8](https://github.com/bigcommerce/checkout-js/commit/87c16d82273b32ce73ca762d1ddb63601c310fa0))
* **extension:** CHECKOUT-8964 Introduce GetConsignment Command ([#2148](https://github.com/bigcommerce/checkout-js/issues/2148)) ([c9f806d](https://github.com/bigcommerce/checkout-js/commit/c9f806d69a9354cb9e1aaa47cfd3562bcb3d390c))
* **other:** LOCAL-1444 delivery translation ([033c892](https://github.com/bigcommerce/checkout-js/commit/033c892658a5fdfdfa710f7aef020c6a2e28effb))
* **other:** LOCAL-1444 delivery translation ([4c9b033](https://github.com/bigcommerce/checkout-js/commit/4c9b033ebc0b2a610407f7c8ea45b3d6f9a6d443))
* **other:** LOCAL-1444 delivery translation ([5b8f30b](https://github.com/bigcommerce/checkout-js/commit/5b8f30bfe2cd034b16de014cdb0c0f2738aec354))
* **other:** LOCAL-1444 delivery translation ([78def16](https://github.com/bigcommerce/checkout-js/commit/78def16ef76b05552a7eb2f1b74260d976437006))
...
* **other:** LOCAL-1444 delivery translation ([#2021](https://github.com/bigcommerce/checkout-js/issues/2021)) ([a55d7c4](https://github.com/bigcommerce/checkout-js/commit/a55d7c460d744ba5b38464eae0103cb2ad9d9575))
* **other:** LOCAL-1444 delivery translation ([#2031](https://github.com/bigcommerce/checkout-js/issues/2031)) ([496996c](https://github.com/bigcommerce/checkout-js/commit/496996cfd92e5b846e0f995310947c8e97c0eb63))
* **other:** LOCAL-1444 delivery translation ([#2044](https://github.com/bigcommerce/checkout-js/issues/2044)) ([edf8c59](https://github.com/bigcommerce/checkout-js/commit/edf8c59ac4b1a4d2b0885cdd0115716c9fdf9fd6))
* **other:** LOCAL-1444 delivery translation ([#2044](https://github.com/bigcommerce/checkout-js/issues/2044)) ([d6be270](https://github.com/bigcommerce/checkout-js/commit/d6be270169c106a1dad0276f95d429fc9c7852cd))
* **other:** LOCAL-1444 delivery translation ([#2044](https://github.com/bigcommerce/checkout-js/issues/2044)) ([06fd034](https://github.com/bigcommerce/checkout-js/commit/06fd034ec4b7d55b0a8d306148373aed5c901e63))
* **other:** LOCAL-1444 delivery translation ([#2044](https://github.com/bigcommerce/checkout-js/issues/2044)) ([497da4b](https://github.com/bigcommerce/checkout-js/commit/497da4b711b623d8d0b8d1b043589b03db982090))
* **other:** LOCAL-1444 delivery translation ([#2089](https://github.com/bigcommerce/checkout-js/issues/2089)) ([60deec0](https://github.com/bigcommerce/checkout-js/commit/60deec073f479dfcd9a6f2f819da1e09857a1457))
* **other:** LOCAL-1444 delivery translation ([#2108](https://github.com/bigcommerce/checkout-js/issues/2108)) ([2f4ae50](https://github.com/bigcommerce/checkout-js/commit/2f4ae50aa14601172b8dc7c8612ab1c8fb8c1082))
* **other:** LOCAL-1444 delivery translation ([#2128](https://github.com/bigcommerce/checkout-js/issues/2128)) ([b40f75c](https://github.com/bigcommerce/checkout-js/commit/b40f75cbd2457b46f7b0defba724b55631ee1aa4))
...
* **payment:** PAYPAL-4692 fixed credit card loading glitch ([ead74ed](https://github.com/bigcommerce/checkout-js/commit/ead74edab439ed4bd1c8ebf08ae1f903ff29b056))
* **payment:** PAYPAL-4827 fixed fastlane shipping strategy bug ([1eec17a](https://github.com/bigcommerce/checkout-js/commit/1eec17aa9b589e8b458e2dd0c83233154982fd52))
* **payment:** PAYPAL-4987 fixed credit card duplication when initializing BT LPM ([a235cd4](https://github.com/bigcommerce/checkout-js/commit/a235cd452794593790826e98c3574454d3987fd9))
* **payment:** PI-1564 Refactor the existing `Moneris` components in … ([#2082](https://github.com/bigcommerce/checkout-js/issues/2082)) ([211bdf2](https://github.com/bigcommerce/checkout-js/commit/211bdf2284e5a3f17792d892dc7d5d16e2f1cd58))
* **payment:** PI-1568 Write authorizenet and checkoutcom googlepay integration tests ([#2007](https://github.com/bigcommerce/checkout-js/issues/2007)) ([249120e](https://github.com/bigcommerce/checkout-js/commit/249120e6effebc7fd9c586b6c36cc20d22b45f6f))
...
* **payment:** PI-1595 Refactor the existing `AmazonPay` and `AmazonP… ([#2032](https://github.com/bigcommerce/checkout-js/issues/2032)) ([f817b7f](https://github.com/bigcommerce/checkout-js/commit/f817b7f3a19b74745ab1df4e5f847872d06aaf20))
...
* **payment:** PI-3048 [Checkout.com] Remove issuers dropdown and sending BIC ([#2141](https://github.com/bigcommerce/checkout-js/issues/2141)) ([a43f332](https://github.com/bigcommerce/checkout-js/commit/a43f33235a616d78d1ceb5f818a8ec5a7fba3f6d))
...
* **payment:** STRIPE-459 move Accordion to package ([50a0b11](https://github.com/bigcommerce/checkout-js/commit/50a0b1140f275cac8f9903af30c2f796b0e08145))
* **payment:** STRIPE-460 Add custom checklist Item ([8cf4aa1](https://github.com/bigcommerce/checkout-js/commit/8cf4aa17f57448088c445b608867deb6ad41960c))
* **payment:** STRIPE-473 bump checkout-sdk to 1.668.0 ([c5154d2](https://github.com/bigcommerce/checkout-js/commit/c5154d21a42eda99c6bd35141e0ed6d48c1d5468))
* **payment:** STRIPE-476 bump checkout-sdk version to 1.677.0 ([a7a1810](https://github.com/bigcommerce/checkout-js/commit/a7a18109a46deb923c28685c0edb80e91d118c99))
* **payment:** STRIPE-488 add Google Pay error text ([098e78f](https://github.com/bigcommerce/checkout-js/commit/098e78fa5bddcb5d5c61e84a2a9d71d047d8ecfa))
* **payment:** STRIPE-489 Stripe accordion toggle ([5f47a5a](https://github.com/bigcommerce/checkout-js/commit/5f47a5a3b774ac5adf507fdd1a1bf91624715eed))
* **payment:** STRIPE-546 allow billing address edit on Google Pay ([a23e3f9](https://github.com/bigcommerce/checkout-js/commit/a23e3f98b7be59c7a813baa3128ea41bbcdf3eee))
* **shipping:** CHECKOUT-8776 Update Field Error Message ([#2073](https://github.com/bigcommerce/checkout-js/issues/2073)) ([bca6dd9](https://github.com/bigcommerce/checkout-js/commit/bca6dd96e28f4d6c25853150dcbf1a6bb79224db))
* **shipping:** CHECKOUT-8861 Handle promotional item in multishipping ([#2118](https://github.com/bigcommerce/checkout-js/issues/2118)) ([2123002](https://github.com/bigcommerce/checkout-js/commit/2123002091dffb6f8dca95163f9083fec8bf110f))


### Bug Fixes

* **checkout:** CHECKOUT-7560 fix experiment name ([#2122](https://github.com/bigcommerce/checkout-js/issues/2122)) ([0ea9404](https://github.com/bigcommerce/checkout-js/commit/0ea9404eb559e1355605dfc98fc06af08fad2819))
* **checkout:** CHECKOUT-8006 feedback create a separated debounced when experiment is on ([bfdb865](https://github.com/bigcommerce/checkout-js/commit/bfdb865bbccfae6c073105fbed0758f4b006dc8a))
* **checkout:** CHECKOUT-8006 feedback use isExperimentEnabled ([f67f03a](https://github.com/bigcommerce/checkout-js/commit/f67f03aea67c0862437d2d02f8f457a350e3b007))
* **checkout:** CHECKOUT-8006 Fix Editting Shipping Address ([b0d182b](https://github.com/bigcommerce/checkout-js/commit/b0d182b22958fa4b403ac2a4bb85d7af998fdbdf))
* **checkout:** CHECKOUT-8006 improve naming ([f382717](https://github.com/bigcommerce/checkout-js/commit/f382717ded0588ca92373eed27919810fe953056))
...
* **checkout:** CHECKOUT-8519 Enable integrity hashes when experiment is on ([bf364a1](https://github.com/bigcommerce/checkout-js/commit/bf364a192e05adaeb280a57e139f1be92781930d))
* **checkout:** CHECKOUT-8803 fix reordering of consignments in multishipping ([#2127](https://github.com/bigcommerce/checkout-js/issues/2127)) ([2560aff](https://github.com/bigcommerce/checkout-js/commit/2560affe65f24042b4acb9bead2bb84e1f80a3f1))
* **checkout:** CHECKOUT-8824 Fix Error Message for First Consignment ([#2123](https://github.com/bigcommerce/checkout-js/issues/2123)) ([d802204](https://github.com/bigcommerce/checkout-js/commit/d80220427109a8d2a408723752df5ddcc672c2d8))
* **checkout:** CHECKOUT-8869 Handle Errors in Extension Rendering ([#2105](https://github.com/bigcommerce/checkout-js/issues/2105)) ([4fddc1b](https://github.com/bigcommerce/checkout-js/commit/4fddc1bbfbe7efca8fd2481a26b9304794d51414))
* **checkout:** CHECKOUT-8892 Update Digital Item Price Mapping ([#2130](https://github.com/bigcommerce/checkout-js/issues/2130)) ([b14929a](https://github.com/bigcommerce/checkout-js/commit/b14929ad40d70a18c501d19fa593f360adcd802f))
* **checkout:** CHECKOUT-8919 resolve cosmetic ui issues for new multishipping ([#2136](https://github.com/bigcommerce/checkout-js/issues/2136)) ([9b20bac](https://github.com/bigcommerce/checkout-js/commit/9b20bac1e2a4879fe11f2946d4402a929df50eb6))
* **checkout:** PI-116 use Square via v2 resolver, removed v1 resolver experiment ([5e460ad](https://github.com/bigcommerce/checkout-js/commit/5e460adfaee15af536285dd51af8bbc67ba19237))
...
* **checkout:** PI-2633 removed modal window that appears during the frictionless 3ds flow for Adyen ([c284e7a](https://github.com/bigcommerce/checkout-js/commit/c284e7a57e491415615bb6103f6eb5571b6c1c4a))
...
* **extension:** CHECKOUT-8960 Fix Broadcast Interruption ([#2143](https://github.com/bigcommerce/checkout-js/issues/2143)) ([e31f838](https://github.com/bigcommerce/checkout-js/commit/e31f838aacf462a7fa3da509814b80f5e799ce77))
* **other:** CHECKOUT-8519 Skip merging manifests if the build is unsuccessful ([8c1f5a3](https://github.com/bigcommerce/checkout-js/commit/8c1f5a3d5dcb59836cbc0076965135cbc776d0ce))
...
* **payment:** PAYPAL-4646 fixed the issue with Google Pay button styling on top of checkout page ([56555c9](https://github.com/bigcommerce/checkout-js/commit/56555c9a731bab960c3b88452d3f9e5591f58732))
* **payment:** PAYPAL-5026 updated import source for isPayPalCommerceFastlaneMethod method ([4bd2e98](https://github.com/bigcommerce/checkout-js/commit/4bd2e98216f1e00d2b726aa1a867eff4662e06c3))
...
* **shipping:** CHECKOUT-7560 add max length validation for address fields ([#2112](https://github.com/bigcommerce/checkout-js/issues/2112)) ([3d44c54](https://github.com/bigcommerce/checkout-js/commit/3d44c54db3c96d856254917bcc7a4af6cffe0a67))
* **shipping:** CHECKOUT-8776 Add validation of form field for max length for google autocomplete ([#2064](https://github.com/bigcommerce/checkout-js/issues/2064)) ([2cdb1f2](https://github.com/bigcommerce/checkout-js/commit/2cdb1f21adaefad39ee1283df57d1ceb6c3a8b22))
* **shipping:** CHECKOUT-8872 Fix Missing Shipping Option ([#2114](https://github.com/bigcommerce/checkout-js/issues/2114)) ([b4bd7b4](https://github.com/bigcommerce/checkout-js/commit/b4bd7b455525186c332f59831d3e8a1007c64d93))
...
* **payment:** PAYPAL-4157 removed unnecessary Fastlane shipping strategy initialization ([b31e22f](https://github.com/bigcommerce/checkout-js/commit/b31e22f1cb6986eff52a9c1beb2b0519b116cc89))
...
### [1.557.1-prerelease.1737979760287](https://github.com/bigcommerce/checkout-js/compare/v1.509.1...v1.557.1-prerelease.1737979760287) (2025-01-27)
...
* **other:** LOCAL-1444 delivery translation ([#2044](https://github.com/bigcommerce/checkout-js/issues/2044)) ([2230e42](https://github.com/bigcommerce/checkout-js/commit/2230e42307531589f42e64d6ad93961df859803e))
